# RonFHIR
R on FHIR is an easy to use wrapper around the 'HL7 FHIR' REST API (STU 3 and R4). It provides tools to easily read and search resources on a FHIR server and bring the results into the R environment. R on FHIR is based on the FhirClient of the '[Firely .NET SDK](https://github.com/FirelyTeam/firely-net-sdk)', also made by [Firely](https://fire.ly/).
